...
/******************************LOG DEBUG FUNCTION******************************/
#define LOG_ENABLE								    ENABLE //ENABLE//DISABLE//DISABLE//ENABLE//DISABLE//default disable log  XXX
#if(LOG_ENABLE)
...
#define SENCE_FUNCTION								        ENABLE //ENABLE//DISABLE
#define COUNT_DOWN_FUNCTION								    ENABLE //ENABLE//DISABLE
#define SEGMENTED_DIMMER_FUNCTION								    ENABLE //ENABLE//DISABLE
#define TIME_WORK_FUNCTION								    ENABLE //ENABLE//DISABLE
#define MUSIC_FUNCTION								        DISABLE //ENABLE//DISABLE
#define DSITURB_FUNCTION								    DISABLE //ENABLE//DISABLE
...
#define BEACON_REMOTE_FUNCTION							    ENABLE //ENABLE//DISABLE
#endif
