		...
		case SCENE_MODEL:{
			...
			if(hal_clock_time_exceed(sence_uint_cnt_time,compare_time)){
				...
				switch(light_value.sence_model){
					case SCENE_MODEL0:{
						//uint16_t light_value_T=1000,light_value_B=200;
						ty_light_gradual_ctrl_cw(200, 1000);
					}break;
			
					case SCENE_MODEL3:{
						//uint16_t light_value_T=500,light_value_B=1000;
						ty_light_gradual_ctrl_cw(500, 1000);
					}break;
