...
int main(void)
{
	...
	pwm_set_reverse_en(PWM0_RVSE_EN|PWM1_RVSE_EN|PWM3_RVSE_EN|PWM4_RVSE_EN);
	pwm_enable(PWM0_EN|PWM1_EN|PWM2_EN|PWM3_EN|PWM4_EN);
	
	pwm_set_duty(PWM_CHANNEL_RGB_W, PWM_FRQ_SELECTION);
	pwm_set_duty(PWM_CHANNEL_RGB_C, 0);
	pwm_set_duty(PWM_CHANNEL_RGB_R, 0);
	pwm_set_duty(PWM_CHANNEL_RGB_G, 0);
	pwm_set_duty(PWM_CHANNEL_RGB_B, 0);
#endif
...
//	//bp5758d_init
//	ty_light_driver_bp5758d_init();
//#endif

//u8 data_1[6] = {0x00,0x00,0x38,0x6D,0x89,0xB2};
//u8 data_2[6] = {0x1F,0xF1,0x2c,0x46,0x32,0x64};
//
//u8 data_3[5] = {0x2F,0xF1,0x2D,0x10,0x00};
//u8 data_4[5] = {0x3F,0xF1,0x2E,0x10,0x01};
//
//u8 data_5[6] = {0x4F,0xF1,0x2C,0x20,0x32,0x64};
//
//u8 data_6[5] = {0x0F,0xF1,0x30,0x30,0x04};
//			timing_time_set(data_1);			
////			timing_work_set(data_2);	
////			timing_work_set(data_3);
////			timing_work_set(data_4);			
//			timing_work_set(data_5);			
////			timing_work_set(data_6);			
