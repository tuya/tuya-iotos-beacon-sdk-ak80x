...
//     if( memcmp(&sence_ctrl_data.tTargetVal, &sence_ctrl_data.tCurrVal, sizeof(LIGHT_CONTRL_T)) != 0 ) {  /* exist error */
...
// 		light_adjust_RGBWC_hw(sence_ctrl_data.tCurrVal.usRed,sence_ctrl_data.tCurrVal.usGreen,sence_ctrl_data.tCurrVal.usBlue,sence_ctrl_data.tCurrVal.usWarm,sence_ctrl_data.tCurrVal.usCold); 
